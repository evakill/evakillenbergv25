...
const natureDescription = <>
    I love being a student of the outdoors. My travels in my tiny van led me to be outside far more than I ever have been in my life—spending weekends hiking, swimming, camping, and marveling over the natural beauty of this country. <br /><br />
    ...
    <Image
        src={`${process.env.NEXT_PUBLIC_ASSET_PREFIX || ""}/olives.jpg`}
        alt="Olive harvest in California"
        width={0}
        height={0}
        sizes="100vw"
    ...
    />
    <Image
        src={`${process.env.NEXT_PUBLIC_ASSET_PREFIX || ""}/farm.jpeg`}
        alt="Farm in Portland, Oregon"
        width={0}
        height={0}
        sizes="100vw"
        className="w-full h-auto rounded my-3"
    ...
    I’ve also developed an interest in natural building, volunteering at Community Rebuilds in Moab, UT and helping build straw bale houses. In my internship at an intentional community in Massachusetts, I worked on a tiny house using wood frame construction, slip straw insulation, and cobb walls.

    <Image
        src={`${process.env.NEXT_PUBLIC_ASSET_PREFIX || ""}/build.jpeg`}
...
export const natureLeaf: Leaf = {
    ...
    links: ["https://www.petermichaelbauer.com/rewilding", "https://permacultureprinciples.com/permaculture-principles"],
    style: {
