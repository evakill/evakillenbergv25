...
const oneArmyDescription = <>
    ...
    When I traveled to Europe for a maintainer meetup in 2023, I stayed an extra two weeks to live and work at Project Kamp. I had an awesome time working (chopping bushes, designing lids for poop compost containers…), eating from the storage container kitchen, and hanging out with fun, like-minded people.<br /><br />

    The Community Platform taught me how to work within the orchestrated chaos of an open-source repository. It also instilled the importance of open-source, not only on GitHub, but as a way to hold and share knowledge. All One Army projects have an intense focus on documentation and accessibility to replicate their work anywhere in the world, creating decentralized, networked change. I think this model is super inspiring and an effective way to approach the massive problems of our generation.<br /><br />
